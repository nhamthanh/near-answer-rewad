...
// thanhnham add NOTE [gh-pages]:

in `package.json` add 2 commands inside `script`:
   `
    "predeploy": "npm run build",
    "deploy": "gh-pages -d dist",`
    
* [BrowserRouter] is not work with Github page, change to [HashRouter] - you can use it when deploy to others
* No need to add homepage - it may cause some error in sign in
